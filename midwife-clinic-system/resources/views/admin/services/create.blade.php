...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3 mb-0">{{ __('app.add_new_service') }}</h1>
        </div>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.services.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('midwife_fee') is-invalid @enderror" 
                                   id="midwife_fee" name="midwife_fee" value="{{ old('midwife_fee') }}" min="0" step="1000" required>
                            @error('midwife_fee')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control-plaintext" id="calculatedProfit">Rp 0</div>
                </div>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">{{ __('app.save_service') }}</button>
