...
<head>
    ...
    <title>{{ config('app.name', 'Midwife Clinic') }} @yield('title')</title>
...
<body>
    @auth
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                <div class="nav-section-title">{{ __('app.dashboard') }}</div>
                ...
                @if(auth()->user()->isAdmin())
                    <div class="nav-section-title">{{ __('app.admin') }}</div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('admin.reports.transactions') }}">
                                <i class="fas fa-receipt me-2"></i>{{ __('app.transaction_reports') }}
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.patients') }}">
                                <i class="fas fa-users me-2"></i>{{ __('app.patient_reports') }}
                            </a></li>
                        </ul>
                    </div>
                @endif
        ...
        <div class="main-content {{ auth()->check() ? 'sidebar-open' : '' }}">
            <!-- Top Header -->
                    ...
                    <div class="user-dropdown">
                        <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown">
                            ...
                            <div class="d-none d-md-block">
                                <div style="font-size: 0.875rem;">{{ auth()->user()->name }}</div>
                                <div style="font-size: 0.75rem; color: #64748b;">{{ ucfirst(auth()->user()->role) }}</div>
                            </div>
    ...
    <div class="floating-language-switcher" id="languageSwitcher">
        ...
        <div class="language-dropdown">
            <form action="{{ route('language.switch') }}" method="POST" style="margin: 0;">
                @csrf
                <button type="submit" name="locale" value="en" class="language-option {{ app()->getLocale() == 'en' ? 'active' : '' }}">
                    <span class="flag">🇺🇸</span>
                    English
                </button>
                <button type="submit" name="locale" value="id" class="language-option {{ app()->getLocale() == 'id' ? 'active' : '' }}">
                    <span class="flag">🇮🇩</span>
                    Bahasa Indonesia
                </button>
            </form>
